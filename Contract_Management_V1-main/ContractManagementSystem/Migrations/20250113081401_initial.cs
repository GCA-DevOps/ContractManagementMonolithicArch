        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePictureByteArray = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorCompanies", x => x.VendorCompanyId);
                });

            migrationBuilder.CreateTable(
                name: "VendorIndividuals",
                columns: table => new
                {
                    VendorIndividualId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OtherName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorIndividuals", x => x.VendorIndividualId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedDepartment = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Contracts_Departments_RequestedDepartment",
                        column: x => x.RequestedDepartment,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Approval_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Approval_Contracts_ContractId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContractId = table.Column<int>(type: "int", nullable: false),
                    PaymentStructure = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TerminationClauses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TerminationClauses_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Approval_AppUserId",
                table: "Approval",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Approval_ContractId",
                table: "Approval",
                column: "ContractId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractParties_PartyId",
                table: "ContractParties",
                column: "PartyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TerminationClauses_ContractId",
                table: "TerminationClauses",
                column: "ContractId",
                unique: true);
        }
