        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalProcessType = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Approvers_Contracts_ContractId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Collaboration_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                table: "Contract",
                columns: new[] { "Id", "Department", "Parties", "Status", "Type", "Value" },
                values: new object[,]
                {
                    { 1, "dept1", null, "pending", "type1", 1000m },
                    { 2, "dept2", null, "active", "type2", 2000m },
                    { 3, "dept3", null, "rejected", "type1", 3000m },
                    { 4, "dept4", null, "expired", "type2", 4000m },
                    { 5, "dept1", null, "pending", "type1", 5000m },
                    { 6, "dept2", null, "active", "type2", 6000m },
                    { 7, "dept3", null, "rejected", "type1", 7000m },
                    { 8, "dept4", null, "expired", "type2", 8000m },
                    { 9, "dept1", null, "pending", "type1", 9000m },
                    { 10, "dept2", null, "active", "type2", 10000m }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Approvers_ContractId",
                table: "Approvers",
                column: "ContractId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Collaboration_ContractId",
                table: "Collaboration",
                column: "ContractId");
